    ...
    <div class="swiper-container hero-slider">
            <div class="swiper-wrapper">
               ...
               <img src="{{ asset('asset2/images/hero.jpg')}}" alt="">
                      ...
                      <div class="entry-content mt-4">
                          ...
                          <a href="{{ route('adhesion')}}" class="btn gradient-bg mr-2">Adherer maintenant</a>
                          <a href="{{ route('nous')}}" class="btn orange-border">En savoir plus</a>
                          </footer>
                               </div>
                         </div>
                     </div>
        ...
        <span><svg viewBox="0 0 1792 1792" xmlns=""><path d="M1171 960q0 13-10 23l-466 466q-10 10-23 10t-23-10l-50-50q-10-10-10-23t10-23l393-393-393-393q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l466 466q10 10 10 23z" /></svg></span>
        </div>
        <div class="swiper-button-prev flex justify-content-center align-items-center">
        <span><svg viewBox="0 0 1792 1792" xmlns=""><path d="M1203 544q0 13-10 23l-393 393 393 393q10 10 10 23t-10 23l-50 50q-10 10-23 10t-23-10l-466-466q-10-10-10-23t10-23l466-466q10-10 23-10t23 10l50 50q10 10 10 23z" /></svg></span>
        </div>
        </div>
...
<div class="our-causes pt-0">
    ...
    @foreach ($actua as $item)
        
    <div class="col-12 col-md-6 col-lg-4">
            <div class="cause-wrap">
                <figure class="m-0">
                     <a href="{{ route('datailActua', [$item]) }}"><img src="{{ asset('storage/'.$item->image) }}" style="height: 200px;" alt=""></a>
                         <div class="figure-overlay d-flex justify-content-center align-items-center position-absolute w-100 h-100">
                         <a href="{{ route('datailActua', [$item]) }}" class="btn gradient-bg mr-2">Voir detail</a>
                         </div>
               </figure>
