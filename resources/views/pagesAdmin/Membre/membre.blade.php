                        ...
                        <div class="sparkline10-list shadow-reset mg-t-30">
                            <div class="sparkline10-hd">
                                <div class="main-sparkline10-hd">
                                    <h1>Nouveau <span class="basic-ds-n">Membre</span></h1>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="basic-login-inner inline-basic-form">
                                                 @include('error')
                                            <form action="{{ route('store_m')}}" method="post" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-5">
                                                            <input type="text" name="nom" id="nom" value="{{ old('nom') }}" class="form-control basic-ele-mg-b-10" placeholder="Nom" />
                                                            </div>
                                                            <div class="col-lg-5">
                                                            ...
                                                            <br><br>
                                                            <div class="col-lg-5">
                                                                <input type="text" name="postnom" id="postnom" value="{{ old('postnom') }}" class="form-control basic-ele-mg-b-10" placeholder="Nom" />
                                                                </div>
                                                                <div class="col-lg-5">
                                                                    <input type="text" name="prenom" id="prenom" value="{{ old('prenom') }}" class="form-control basic-ele-mg-b-10" placeholder="prenom" />
                                                                    </div><br><br>
                                                                   <p>
                                                                        <div class="col-lg-12">
                                                                                <input type="email" name="email" id="email" value="{{ old('email') }}" class="form-control basic-ele-mg-b-10" placeholder="email" />
                                                                                </div>
