                        ...
                        <div class="sparkline10-list shadow-reset mg-t-30">
                            <div class="sparkline10-hd">
                                <div class="main-sparkline10-hd">
                                    <h1>Actualités <span class="basic-ds-n">publiees</span></h1>
                                            ...
                                            <form action="{{ route('store.data')}}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5">
                                                                <input type="text" name ="fond" id="fond"  value="{{ old('fond') }}"class="form-control basic-ele-mg-b-10" placeholder="Fond" /><br>
                                                            </div>
                                                            <p>
                                                                    <div class="col-lg-5">
                                                                ...
                                                                <div class="col-lg-6">
                                                                        <div class="login-btn-inner">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <input class="btn btn-sm btn-primary login-submit-cs" type="submit" name="submit" id="submit" value="Ajouter" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                ...
                <div class="sparkline13-list shadow-reset">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1>Les <span class="table-project-n">Actualités</span> Table</h1>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true"  data-key-events="true" data-show-toggle="true" data-resizable="true"  data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="true" data-editable="true">Fond</th>
                                        <th data-field="Detail" data-editable="true">Detail</th>
                                        <th>Image</th>
                                ...
                                <tbody>
                                    ...
                                    <td>{{ $v->fond }}</td>
                                    <td>{{ $v->detail }}</td>
                                    <td><img src="{{ asset('storage/'.$v->image) }}" style="width:45px; heidth:35px;"></td>
                                     <td>{{ $v->updated_at }}</td>

                                     <td class="">
                                         <div class="col-lg-3">
                                            <a href="{{ route('editActual', [$v]) }}"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">Modifier</button></a>
                                        </div>
                                        <div class="col-lg-3">
                                                <a href="{{ url('deleteActual', [$v]) }}"><button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="submit">Supprimer</button></a>
                                            </div>
